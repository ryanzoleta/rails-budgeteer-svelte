...
<QueryClientProvider client={queryClient}>
  <div class="flex min-h-screen place-content-center bg-gradient-to-bl from-purple-500 to-cyan-500">
    <div class="flex min-h-screen w-full place-content-center bg-black opacity-75">
      <div class="flex flex-col gap-5 pt-5 xl:w-2/6">
        ...
        <div class="mb-10 rounded-lg bg-zinc-950 p-10">
          <slot />
        </div>
      </div>
    </div>
